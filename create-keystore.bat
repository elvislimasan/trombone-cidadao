@echo off
REM Script para criar keystore para Android (Windows)
REM ==========================================
...
REM Verificar se keytool está disponível
...
REM Criar keystore
keytool -genkey -v -keystore android\app\trombone-cidadao-release.keystore -alias trombone-cidadao -keyalg RSA -keysize 2048 -validity 10000
