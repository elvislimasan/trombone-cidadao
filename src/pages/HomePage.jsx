    ...
    if (typeof category_id !== 'undefined') {
      if (category_id === 'iluminacao') {
        ...
        if (typeof reported_post_identifier !== 'undefined') {
          reportUpdates.reported_post_identifier = reported_post_identifier ? String(reported_post_identifier).trim() : null;
        }
        if (typeof reported_plate !== 'undefined') {
          reportUpdates.reported_plate = reported_plate ? String(reported_plate).trim() : null;
        }
