...
const WebUploadIndicator = () => {
  ...
  return (
    <div className="fixed bottom-[calc(4rem+2rem)] lg:bottom-6 right-6 z-[9999] flex flex-col items-end gap-2">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="bg-card border shadow-xl rounded-xl w-80 overflow-hidden mb-2"
          >
...
export default WebUploadIndicator;
