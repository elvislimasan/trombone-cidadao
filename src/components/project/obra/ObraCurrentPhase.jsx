...
export function ObraCurrentPhase({ phase, category, onEdit, isAdmin = false, embedded = false, showHeader = true, showBody = true }) {
  ...
  const containerClassName = embedded ? (showBody ? "px-6 pb-8" : "") : "bg-card rounded-xl border border-border overflow-hidden ";
  ...
  const bodyClassName = embedded ? "pt-8 lg:pt-7 2xl:pt-8" : "p-4 sm:p-5 lg:p-4 2xl:p-6";
    ...
    <Container className={containerClassName}>
      ...
      {showBody ? (
        <div className={bodyClassName}>
          ...
          <div className="flex items-center gap-2 text-[14px] font-semibold uppercase  text-muted-foreground">
