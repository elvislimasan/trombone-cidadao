              ...
              <div key={i} className="flex gap-2 md:gap-3 p-3 md:p-4 rounded-xl bg-white border shadow-sm hover:shadow-md transition-all">
                ...
                <div className="space-y-1 w-full">
                  <div className="flex items-center gap-1.5 md:gap-2 flex-wrap">
                    ...
                    <span className="text-[10px] md:text-xs text-muted-foreground bg-muted px-2 py-0.5 rounded-full break-words overflow-hidden">{sig.city || 'Brasil'}</span>
                  ...
                  {sig.comment && (
                    <p className="text-[12px] md:text-sm text-foreground/80 leading-relaxed break-words overflow-hidden">"{sig.comment}"</p>
                  )}
                </div>
              </div>
            ))
