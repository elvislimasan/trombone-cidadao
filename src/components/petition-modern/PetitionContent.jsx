      ...
      <CardContent className="space-y-8 p-6 sm:p-8">
        ...
        <section>
          <div className="mb-6 flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-foreground">Entenda a Campanha</h2>
          </div>
          
          <div className="space-y-6">
            {finalContent && (
              <div 
                className="text-muted-foreground leading-relaxed break-words [&_p]:mb-4 [&_h1]:text-2xl [&_h1]:font-bold [&_h1]:mb-4 [&_h2]:text-xl [&_h2]:font-bold [&_h2]:mb-3 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:mb-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mb-4 [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:mb-4"
        ...
        <section className="rounded-xl bg-secondary/50 p-6">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h3 className="font-semibold text-foreground">Por que isso importa?</h3>
          </div>
