...
const StoryRenderer = React.forwardRef(function StoryRenderer(
  { layout, petition, qrCodeUrl, coverPhotoUrl, showQRCode = true, primaryColor = '#e52a2a', imageMode = 'background' },
  ref
) {
  return (
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <div style={{ position: 'fixed', left: -9999, top: 0, width: STORY_WIDTH, height: STORY_HEIGHT, overflow: 'hidden', pointerEvents: 'none' }}>
        <StoryRenderer ref={exportRef} layout={layout} petition={petition} qrCodeUrl={qrCodeUrl} coverPhotoUrl={coverPhotoUrl} showQRCode={showQRCode} primaryColor={primaryColor} imageMode={imageMode} />
      </div>
    </Dialog>
  );
};
